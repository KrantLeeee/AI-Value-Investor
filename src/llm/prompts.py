...
REPORT_CH2_SYSTEM = """你是价值投资分析师。基于价值投资框架和防御性投资准则的分析，撰写竞争力章节（≥500字）。
...
- 示例：不要写"Buffett Agent认为"，改为"基于价值投资框架"
- 示例：不要写"Graham Agent显示"，改为"根据防御性投资准则"
"""

REPORT_CH2_USER = """**价值投资框架分析:**
- 信号: {buffett_signal}
- 护城河: {moat_type}
...
请撰写竞争力分析（≥500字，必须包含"护城河"或"竞争"，避免使用"Agent"等技术术语）。"""
